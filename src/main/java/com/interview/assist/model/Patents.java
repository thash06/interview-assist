...
public class Patents {
     ...
     * @param values
     */
    public Patents(Long total, List<Object> values) {
        super();
        this.total = total;
        this.values = values;
    }
    ...
    public Patents withTotal(Long total) {
        this.total = total;
        return this;
    }
    ...
    public Patents withValues(List<Object> values) {
        this.values = values;
        return this;
    }
    ...
    public Patents withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Patents.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
