...
public class Awards {
     ...
     * @param values
     */
    public Awards(Long total, List<Object> values) {
        super();
        this.total = total;
        this.values = values;
    }
    ...
    public Awards withTotal(Long total) {
        this.total = total;
        return this;
    }
    ...
    public Awards withValues(List<Object> values) {
        this.values = values;
        return this;
    }
    ...
    public Awards withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Awards.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Awards) == false) {
            return false;
        }
        Awards rhs = ((Awards) other);
