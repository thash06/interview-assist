...
public class Publications {
     ...
     * @param values
     */
    public Publications(Long total, List<Object> values) {
        super();
        this.total = total;
        this.values = values;
    }
    ...
    public Publications withTotal(Long total) {
        this.total = total;
        return this;
    }
    ...
    public Publications withValues(List<Object> values) {
        this.values = values;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Publications.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
