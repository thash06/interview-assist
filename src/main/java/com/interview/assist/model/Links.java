...
public class Links {
    ...
    private Long total;
    @JsonProperty("values")
    private List<URLReferences> values;
    @JsonIgnore
     ...
     * @param values
     */
    public Links(Long total, List<URLReferences> values) {
        super();
        this.total = total;
        this.values = values;
    }
    ...
    public Links withTotal(Long total) {
        this.total = total;
        return this;
    }

    @JsonProperty("values")
    public List<URLReferences> getValues() {
        return values;
    }

    @JsonProperty("values")
    public void setValues(List<URLReferences> values) {
        this.values = values;
    }

    public Links withValues(List<URLReferences> values) {
        this.values = values;
        return this;
    }
