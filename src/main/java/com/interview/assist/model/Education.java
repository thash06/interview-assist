...
public class Education {
     ...
     * @param values
     */
    public Education(Long total, List<Diploma> values) {
        super();
        this.total = total;
        this.values = values;
    }
    ...
    public Education withTotal(Long total) {
        this.total = total;
        return this;
    }

    @JsonProperty("values")
    public List<Diploma> getValues() {
        return values;
    }

    @JsonProperty("values")
    public void setValues(List<Diploma> values) {
        this.values = values;
    }

    public Education withValues(List<Diploma> values) {
        this.values = values;
        return this;
    }
