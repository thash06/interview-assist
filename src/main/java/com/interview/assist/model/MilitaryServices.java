...
public class MilitaryServices {
     ...
     * @param values
     */
    public MilitaryServices(Long total, List<Object> values) {
        super();
        this.total = total;
        this.values = values;
    }
    ...
    public MilitaryServices withTotal(Long total) {
        this.total = total;
        return this;
    }
    ...
    public MilitaryServices withValues(List<Object> values) {
        this.values = values;
        return this;
    }
    ...
    public MilitaryServices withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(MilitaryServices.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MilitaryServices) == false) {
            return false;
        }
        MilitaryServices rhs = ((MilitaryServices) other);
