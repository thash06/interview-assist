...
public class Certifications {
     ...
     * @param values
     */
    public Certifications(Long total, List<Object> values) {
        super();
        this.total = total;
        this.values = values;
    }
    ...
    public Certifications withTotal(Long total) {
        this.total = total;
        return this;
    }
    ...
    public Certifications withValues(List<Object> values) {
        this.values = values;
        return this;
    }
    ...
    public Certifications withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Certifications.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Certifications) == false) {
            return false;
        }
        Certifications rhs = ((Certifications) other);
